...
<form action="lib/process_pds.php" method="POST" id="pds_form" enctype="multipart/form-data">
    <p class="text-right">
        <span class="data-entry-msg">Do you want to delete this record ?</span>
        <button type="submit" id="delete_pds_btn" name="delete_pds_btn" class="btn my-btn"><i class="fa fa-check"></i> Ok</button>
        <a href="pds-lists.php" class="btn my-btn"><i class="fa fa-times"></i> Cancel</a>
    </p>
   
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title "><img src="/miaa/assets/images/delete_user.svg" class="user-icon">&nbsp; Delete PDS Data<span class="pull-right"></h3>
        </div>
